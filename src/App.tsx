...
function VictoryScreen() {
  ...
  return (
    ...
    >
      ...
      <div style={{
        width: '100%', background: '#12121e',
        border: '2px solid rgba(76, 175, 110, 0.5)', padding: '16px 12px',
        textAlign: 'center', boxShadow: '4px 4px 0 #000',
      }}>
      ...
      <motion.div
        ...
        style={{
          width: '100%', background: '#12121e',
          border: '2px solid #1c1c2e', padding: '12px',
          boxShadow: '4px 4px 0 #000', display: 'flex', flexDirection: 'column', gap: 0,
        }}
      >
        {[
          ...
          <div key={label} style={{
            display: 'flex', justifyContent: 'space-between',
            borderBottom: '1px solid #1c1c2e', padding: '10px 0',
            fontSize: 8, color: '#b5a89d',
          }}>
            <span>{label}</span>
            <span style={{ color: '#c8a96e' }}>{value}</span>
      ...
      <motion.button
        ...
        style={{
          ...
          color: '#0a0a0f', background: '#4caf91', border: '3px solid #4caf91',
          padding: '14px 20px', cursor: 'pointer', borderRadius: 0,
