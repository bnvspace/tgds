...
export const SWAMP_ENEMIES: Enemy[] = [
  ...
  },
  {
    ...
    maxHp: 180,
    attackPattern: [
      { damage: 22, type: 'physical', description: 'Vine whip' },
      { damage: 16, type: 'physical', description: 'Thorn strike' },
      { damage: 0,  type: 'debuff',  description: 'Root — stagger' },
      { damage: 30, type: 'physical', description: 'Crush' },
      { damage: 18, type: 'magical',  description: 'Spore burst' },
    ],
    patternIndex: 0,
    statusEffects: [],
    blockedReels: [],
