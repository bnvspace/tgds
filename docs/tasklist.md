...
Что делаем:
- [ ] **Физика выпадающих наград:** Анимация вылетающих монет и чипов при победах и наградах.
- [ ] **Атмосфера таверны:** Приглушенный фоновый гул толпы, реакция толпы (cheering) на мощные комбо.
- [ ] **Хрустящий аудио-дизайн:** Механические щелчки вращения барабанов, металлический лязг для физ. атак, эфирный звук для магии.
- [ ] **Визуальный сок (Juice):** Тряска камеры (camera shake) при получении урона и критах, мерцание экрана.
